...
(function (ng, undefined) {
      ...
      .directive('stSort', ['$parse', function ($parse) {
          return {
              ...
              link: function (scope, element, attr, ctrl) {
                  ...
                  var index = 0;
                  var classAscent = attr.stClassAscent || 'sorting_asc';
                  var classDescent = attr.stClassDescent || 'sorting_desc';
    ...
    ng.module('smart-table')
    .directive('stLoaded', function ($parse) {
        return {
            require: 'stTable',
            replace: false,
            scope: {
            ...
            link: {
                pre: function (scope, element, attrs, ctrl) {
                    if (ng.isFunction(scope.stLoaded)) {
                        ctrl.loaded = function () {
                            return scope.stLoaded(ctrl.tableState(), ctrl);
                        }
                    }
                }
            }
    ...
    ng.module('smart-table')
    .directive('stLoadStart', function () {
        return {
            require: 'stTable',
            scope: {
                stLoadStart: '='
            ...
            link: {
                pre: function (scope, element, attrs, ctrl) {
                    if (ng.isFunction(attrs.stLoadStart)) {
                        ctrl.loadStart = function () {
                            return scope.stLoadStart(ctrl.tableState(), ctrl);
                        }
                    }
                }
            }
